-- Repair candidate databases that already recorded an earlier version of 044.
-- The earlier migration cleared legacy run pointers but did not normalize the
-- promoted main lane role. Keep this repair idempotent so fresh databases may
-- safely run it after the corrected 044 migration.
